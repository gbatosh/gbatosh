...
img_main = pygame.image.load('pp2/lab7/docs/mickeyclock_body.png')
img_main = pygame.transform.scale(img_main, (screen_w, screen_h))

img_hand1 = pygame.image.load('pp2/lab7/docs/mmc1.png')
img_hand1 = pygame.transform.scale(img_hand1, (221, 350))

img_hand2 = pygame.image.load('pp2/lab7/docs/mmc2.png')
img_hand2 = pygame.transform.scale(img_hand2, (165, 300))
radius = 40 # necassary radius
